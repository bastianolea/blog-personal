---
title: "Libros que leí en 2024"
subtitle: "Lista de lectura personal"
date: "2024-12-31"
image: bastimapache_mosaico_libros_2024.jpg
format: html
categories: [libros]
editor_options: 
...
libros <- data |> 
  select(date_read,
         ...
         book_id) |> 
  filter(!is.na(date_read)) |> 
  filter(year(ymd(date_read)) == 2024) |> 
  # limpiar datos
...
# libros <- libros |> 
#   add_row(
#     date_read = ymd("2025-03-30"),
#     title = "Manifiesto cíborg",
#     author = "Donna J. Haraway",
#     publisher = "Kaótica Libros",
#     my_rating = 4,
#     number_of_pages = 140,
#     book_id = 56752021,
#     portada = glue("portadas/{56752021}.jpg"),
#     link = glue("https://www.goodreads.com/book/show/{56752021}")
#   )
```


Esta es la lista de los **`r (nrow(libros))`** libros que leí durante el 2024, según [mi perfil de GoodReads](https://www.goodreads.com/user/show/53224910-basti-n-olea-herrera).

Durante 2024 me propuse **leer 30 libros**, pero no lo logré 😞
...
walk(libros$book_id, \(id) {
  ...
  ruta <- "posts/libros/libros_2024/portadas/"
