---
title: "Libros que leí en 2025"
subtitle: "Lista de lectura personal"
date: "2025-12-31"
image: bastimapache_mosaico_libros_2025.jpg
format: html
categories: [libros]
editor_options: 
...
Esta es la lista de los **`r (nrow(libros))`** libros que leí durante el 2025, según [mi perfil de GoodReads](https://www.goodreads.com/user/show/53224910-basti-n-olea-herrera).

Durante 2025 me propuse **leer 20 libros**, pero no lo logré 😞
...
walk(libros$book_id, \(id) {
  ...
  ruta <- "posts/libros/libros_2025/portadas/"
